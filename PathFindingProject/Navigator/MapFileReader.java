...
// C.McArdle, DCU, 2017
//
// Used by ObstableMap to read an input map file to construct a Polygon2D object.
// It isn't necessary to edit this code to implement your project.
//
...
class MapFileReader {
	...
	protected Polygon2D getFirstPoly() {
		return parsePolygonData().get(0);
	}
